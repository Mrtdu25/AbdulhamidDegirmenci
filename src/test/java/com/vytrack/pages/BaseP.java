...
public abstract class BaseP {
    ...
    public void clickOnCreateButton(String button){
        WebElement createBtn = Driver.getDriver().findElement(By.cssSelector("[title='"+button+"']"));
        BrowserUtils.clickOnElement(createBtn);
    }
    ...
    public void navigateTo(String tab, String module) {
        WebDriverWait wait = new WebDriverWait(Driver.getDriver(), 80);
